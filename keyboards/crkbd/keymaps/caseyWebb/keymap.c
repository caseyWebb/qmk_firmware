...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_split_3x6_3(
    ...
    MT(MOD_LGUI, KC_GRAVE), KC_COLN, KC_Q,         KC_J,        KC_K, KC_X, KC_B,  KC_M, KC_W, KC_V, KC_Z, KC_ENT,

    KC_RALT, KC_RSFT, LT(1, KC_ESC),                                  LT(2, KC_SPC), MT(MOD_RGUI, KC_TAB), MT(MOD_RCTL, KC_BSPC)
  ),

  [1] = LAYOUT_split_3x6_3(
    LGUI(LSFT(KC_4)),   KC_HASH, KC_PERC, KC_LCBR,     KC_RCBR,     KC_LABK,      KC_EQUAL, KC_7, KC_8, KC_9, KC_ASTR, KC_TRANSPARENT,
  ...
  [2] = LAYOUT_split_3x6_3(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_PGDOWN,      KC_LEFT,             KC_DOWN,             KC_RIGHT,            KC_RSFT,        KC_AUDIO_VOL_DOWN,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MEDIA_PREV_TRACK, KC_MEDIA_PLAY_PAUSE, KC_MEDIA_NEXT_TRACK, KC_RALT,        KC_AUDIO_MUTE,
